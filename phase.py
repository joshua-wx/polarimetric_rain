...
def phidp_bringi(radar, gatefilter, phidp_field='PHIDP', refl_field='DBZ'):
    """
    ...
    dp_unwraped = pyart.correct.dealias_unwrap_phase(radar,
                                           gatefilter=gatefilter,
                                           skip_checks=True,
                                           vel_field=phidp_field,
                                           nyquist_vel=180)
    system_phase = pyart.correct.phase_proc.det_sys_phase_gf(radar, gatefilter, phidp_field=phidp_field, first_gate=30)
    dp = dp_unwraped['data'].copy() - system_phase
    dp = dp.filled(-9999)
